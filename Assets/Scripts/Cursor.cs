...
public abstract class MyCursor : MonoBehaviour, ICursor
{
    ...
    public CursorTransformEnum CursorType { get { return cursorType; } }
    private CursorTransformEnum cursorType = CursorTransformEnum.None;
    ...
    protected ICursorTransform TargetedCursorSecondary;
    ...
    private CursorTransformEnum targetType;
    ...
    protected virtual void OnFocusedObjectChanged(GameObject previousObject, GameObject newObject)
    {
        ...
        if (newObject != null)
        {
            ...
            OnActiveSecondary(newObject.GetComponent<CursorTransform>());
        }
    }

    protected virtual void OnActiveSecondary(CursorTransform secondary)
    {
        TargetedCursorSecondary = secondary;
    }
    ...
    protected virtual void UpdateCursorTransform()
    {
        ...
        else
        {
            ...
            {
                TargetedCursorModifier.GetModifiedTransform(this, out targetPosition, out targetRotation, out targetScale/*, out targetType*/);
            }
            else
            {
    ...
    protected virtual void UpdateCursorSecondary()
    {
        if (TargetedObject == null) return;
        if (TargetedCursorSecondary == null) return;
        TargetedCursorSecondary.GetModifiedCursorType(this, out targetType);
    }
